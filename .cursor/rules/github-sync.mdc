...
---
---
description: This file provides instructions for syncing GitHub issues with a custom ticketing system. It includes available commands, ticket file format, and sync rules.
applyTo: '**'
---
# {
#  "scripts": {
